...
def add_deep_sky_branding(ax, font_props=None, data_note='DATA: CALIFORNIA DEPARTMENT OF INSURANCE AND US FOREST SERVICE'):
    """
    ...
    # Add Deep Sky icon at the bottom-right
    ...
    if os.path.exists(icon_path):
        ...
        # Position at a fixed spot in the bottom-right
        ab = AnnotationBbox(imagebox, (0.9, 0.01),
