...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function checkDevice() {
    ...
    if (isMobile()) {
      ...
      waitForElement(".desktop-element", (desktopElement) => desktopElement.remove());
    } else {
      console.log("Desktop version active");
      waitForElement(".mobile-element", (mobileElement) => mobileElement.remove());
    }
  }
...
<script>
    const API_BASE_URL = 'https://o1fbng172d.execute-api.ca-central-1.amazonaws.com/test';
